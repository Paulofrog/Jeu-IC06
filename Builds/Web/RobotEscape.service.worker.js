...
/** @type {string} */
const CACHE_VERSION = '1736699147|590105426';
/** @type {string} */
const CACHE_PREFIX = 'Jeu-IC06-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'RobotEscape.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["RobotEscape.html","RobotEscape.js","RobotEscape.offline.html","RobotEscape.icon.png","RobotEscape.apple-touch-icon.png","RobotEscape.worker.js","RobotEscape.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["RobotEscape.wasm","RobotEscape.pck"];
